...
def run_derivation(generate_eqs):
    ...
    if generate_eqs:
        ...
        code_gen.write_cov_matrix('covariance_prediction', generate_cov_prediction(P, F, Q))

        print("Generating Observation Equations...")

        code_gen.write_obs_eqs('gps_fusion', __generate_observation_equations(P, state_vector, H_gps, R_gps))
        code_gen.write_obs_eqs('baro_fusion', __generate_observation_equations(P, state_vector, H_baro, R_baro))
        code_gen.write_obs_eqs('mag_fusion', __generate_observation_equations(P, state_vector, H_mag, R_mag))
